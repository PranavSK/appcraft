...
export type GeogebraAppParams = Record<string, unknown>;
// export interface GeogebraAppParams {
//   /**
...
//   buttonRounding: Number (0 - 0.9)
//   buttonBorderColor: Hex color (#RGB, #RGBA, #RRGGBB or #RRGGBBAA)
//   editorBackgroundColor: Hex color
//   editorForegroundColor: Hex color
//   textmode: true or false
//   showKeyboardOnFocus: "false"|"true"|"auto"
//   keyboardType: "scientific"|"normal"|"notes"
//   transparentGraphics: true or false
// }
...
export interface GeogebraAppApi {
  ...
  setDisplayStyle(
    objName: string,
    style: 'parametric' | 'explicit' | 'implicit' | 'specific',
  ): void;
